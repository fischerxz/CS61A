...
def calc_eval(exp):
    ...
    if isinstance(exp, Pair):
        ...
        if operator == 'and': # and expressions
            ...
            op = calc_eval(operator)
            args = operands.map((calc_eval))
            return calc_apply( op, args) # UPDATE THIS FOR Q2
...
def floor_div(args):
    ...
    def helper(args, n):
        if args is nil or args.rest is nil:
            ...
            return helper(args.rest, n // args.rest.first)
    return helper(args, args.first)
